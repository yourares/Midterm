...
public class Student_Test {
	...
	public static void setup() throws PersonException {
		...
		Student1 = new Student("Ann1", "Li1", "L1", new Date(), "BUSINESS", "address1", "(302)-181-5699",
				"Ann1@udel.edu");
		Student2 = new Student("Ann2", "Li2", "L2", new Date(), "BUSINESS", "address2", "(302)-181-5699",
				"Ann2@udel.edu");
		Student3 = new Student("Ann3", "Li3", "L3", new Date(), "COMPSI", "address3", "(302)-243-1595",
				"Ann3@udel.edu");
		Student4 = new Student("Ann4", "Li4", "L4", new Date(), "COMPSI", "address4", "(302)-243-1595",
				"Ann4@udel.edu");
		...
		Student7 = new Student("Ann7", "Li7", "L7", new Date(), "PHYSICS", "address7", "(302)-585-7964",
				"Ann7@udel.edu");
		Student8 = new Student("Ann8", "Li8", "L8", new Date(), "PHYSICS", "address8", "(302)-585-7964",
				"Ann8@udel.edul");
		Student9 = new Student("Ann9", "Li9", "L9", new Date(), "NURSING", "address9", "(302)-816-5060",
				"Ann9@udel.edu");
		Student10 = new Student("Ann10", "Li10", "L10", new Date(), "NURSING", "address10", "(302)-816-5060",
				"Ann10@udel.edu");
				...
				for (Semester l : SemesterList) {
					if (l.getSemesterID() == l.getSemesterID()) {
						for (Course m : CourseList) {
							if (m.getCourseID() == m.getCourseID()) {
								for (Section s : SectionList) {
									if (s.getSectionID() == i.getSectionID()) {
										sumofPoints += i.getGrade() * m.getGradePoints();
										culmulativeGrade += m.getGradePoints();
									}
								}
							}
						}
